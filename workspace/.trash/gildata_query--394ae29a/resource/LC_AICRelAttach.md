...
1.内容说明: 收录根据上市公司在招投说明书、定期报告及临时公告中披露的一致行动人的每个人单独的详细信息。
2.数据范围：2019年至今
...
|------|--------|--------|------|------|--------|------|
| 1 | `ID` | ID | number(19) | ✗ |  |  |
| 2 | `RID` | RID | number(19) | ✗ | 100.0% | RID(RID)：与 一致行动人关系（LC_AICRelationship）ID字段关联，获取公司代码、信息发布日期等信... |
...
| 5 | `ActInConcertID` | 一致行动人ID | number(10) | ✓ | 48.27% | 一致行动人ID（ActInConcertID）：当一致行动人性质（ActInConcertNature）=2时，与机构基... |
...
RID(RID)：与
一致行动人关系（LC_AICRelationship）ID字段关联，获取公司代码、信息发布日期等信息
