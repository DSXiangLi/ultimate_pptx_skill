...
| 4 | `MediaCode` | 媒体出处代码 | number(10) | ✓ | 98.6% | 媒体出处代码(MediaCode)与(NI_NewsConst)表中的DM字段关联，令LB = 4，得到媒体出处代码的具... |
| 5 | `Writer` | 撰写机构 | varchar2(50) | ✓ | 36.26% |  |
| 6 | `Author` | 作者 | varchar2(50) | ✓ | 65.67% |  |
| 7 | `InfoTitle` | 标题 | varchar2(200) | ✗ | 100.0% |  |
| 8 | `Content` | 信息内容 | clob | ✓ | 2.34% |  |
...
| 12 | `RecordDate` | 记录录入时间 | date | ✓ | 64.78% |  |
| 13 | `XGRQ` | 更新时间 | date | ✗ |  |  |
