...
| 属性 | 值 |
|------|-----|
| 表名 | `ED_ForeignRemarks` |
| MySQL表名 | `ed_foreignremarks` |
| 中文名 | 海外评论 |
...
| 5 | `Writer` | 撰写机构 | varchar2(50) | ✓ | 3.11% |  |
| 6 | `Author` | 作者 | varchar2(50) | ✓ | 49.1% |  |
| 7 | `InfoTitle` | 标题 | varchar2(200) | ✗ | 100.0% |  |
| 8 | `Content` | 信息内容 | clob | ✓ | 0.29% |  |
| 9 | `ObjectCode` | 信息对象代码 | number(10) | ✓ | 100.0% | 信息对象代码(ObjectCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1008，得到信息... |
| 10 | `AreaCode` | 信息地域划分代码 | number(10) | ✓ | 100.0% | 信息地域划分代码(AreaCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1023，得到信息... |
| 11 | `InfoLevel` | 信息级别 | number(10) | ✓ | 100.0% | 信息级别(InfoLevel)的取值为0、1、2 |
| 12 | `RecordDate` | 记录录入时间 | date | ✓ | 92.91% |  |
| 13 | `XGRQ` | 更新时间 | date | ✗ |  |  |
