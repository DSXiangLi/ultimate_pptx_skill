...
| 属性 | 值 |
|------|-----|
| 表名 | `MF_FundDownsideDevN` |
| MySQL表名 | `mf_funddownsidedevn` |
| 中文名 | 基金下行标准差(全) |
...
1.内容说明：记录不同计算周期、计算步长、临界收益率下的下行标准差指标值。
2.数据范围：2022年12月起-至今。
...
| 13 | `InFiveYear` | 截止日5年前 | number(18,9) | ✓ | 35.73% |  |
| 14 | `InSevenYear` | 截止日7年前 | number(18,9) | ✓ | 22.43% |  |
| 15 | `InTenYear` | 截止日10年前 | number(18,9) | ✓ | 9.13% |  |
