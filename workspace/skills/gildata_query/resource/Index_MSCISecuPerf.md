...
| 属性 | 值 |
|------|-----|
| 表名 | `Index_MSCISecuPerf` |
| MySQL表名 | `index_mscisecuperf` |
| 中文名 | MSCI指数成份行情表现 |
...
内容说明：收录MSCI指数成份月度成交量、换手率指标数据。统计区间为：近一月、近三月、近半年、近一年。
数据范围：2003年至今
信息来源：MSCI
...
| 5 | `RIC` | 路孚特代码 | varchar2(100) | ✓ | 99.86% |  |
| 6 | `InnerCode` | 证券内部编码 | number(10) | ✓ | 32.11% | 证券内部编码(InnerCode)：关联不同主表，查询证券代码、证券简称等基本信息。当0<SecuInnerCode<=... |
| 7 | `SecuMarket` | 证券市场 | number(10) | ✓ | 100.0% | 证券市场(SecuMarket)与(CT_SystemConst)表中的DM字段关联，令LB=201，得到证券市场的具体... |
| 8 | `RM_ATVR_I` | 近一个月年化换手率I(%) | number(19,2) | ✓ | 46.37% |  |
| 9 | `RM_ATVR_II` | 近一个月年化换手率II(%) | number(19,2) | ✓ | 46.37% |  |
| 10 | `RM_ATV` | 近一个月年化平均成交量 | number(30,6) | ✓ | 46.37% |  |
| 11 | `RM_FreqOfTrading` | 近一个月行情天数/交易日天数(%) | number(19,2) | ✓ | 46.36% |  |
| 12 | `RM_AggrATVR_I` | 近一个月年化总换手率I(%) | number(19,2) | ✓ | 46.38% |  |
| 13 | `RM_AggrATVR_II` | 近一个月年化总换手率II(%) | number(19,2) | ✓ | 46.39% |  |
| 14 | `RM_AggrATV` | 近一个月年化总平均成交量 | number(30,6) | ✓ | 46.39% |  |
| 15 | `RMThree_ATVR_I` | 近三个月年化换手率I(%) | number(19,2) | ✓ | 99.81% |  |
| 16 | `RMThree_ATVR_II` | 近三个月年化换手率II(%) | number(19,2) | ✓ | 99.83% |  |
| 17 | `RMThree_ATV` | 近三个月年化平均成交量 | number(30,6) | ✓ | 46.31% |  |
| 18 | `RMThree_FreqOfTrading` | 近三个月行情天数/交易日天数(%) | number(19,2) | ✓ | 99.67% |  |
| 19 | `RMThree_AggrATVR_I` | 近三个月年化总换手率I(%) | number(19,2) | ✓ | 99.99% |  |
| 20 | `RMThree_AggrATVR_II` | 近三个月年化总换手率II(%) | number(19,2) | ✓ | 100.0% |  |
| 21 | `RMThree_AggrATV` | 近三个月年化总平均成交量 | number(30,6) | ✓ | 44.27% |  |
| 22 | `RMSix_ATVR_I` | 近六个月年化换手率I(%) | number(19,2) | ✓ | 46.1% |  |
| 23 | `RMSix_ATVR_II` | 近六个月年化换手率II(%) | number(19,2) | ✓ | 46.13% |  |
| 24 | `RMSix_ATV` | 近六个月年化平均成交量 | number(30,6) | ✓ | 46.13% |  |
| 25 | `RMSix_FreqOfTrading` | 近六个月行情天数/交易日天数(%) | number(19,2) | ✓ | 46.05% |  |
| 26 | `RMSix_AggrATVR_I` | 近六个月年化总换手率I(%) | number(19,2) | ✓ | 46.38% |  |
| 27 | `RMSix_AggrATVR_II` | 近六个月年化总换手率II(%) | number(19,2) | ✓ | 46.39% |  |
| 28 | `RMSix_AggrATV` | 近六个月年化总平均成交量 | number(30,6) | ✓ | 46.39% |  |
| 29 | `RY_ATVR_I` | 近一年年化换手率I(%) | number(19,2) | ✓ | 97.19% |  |
| 30 | `RY_ATVR_II` | 近一年年化换手率II(%) | number(19,2) | ✓ | 97.27% |  |
| 31 | `RY_ATV` | 近一年年化平均成交量 | number(30,6) | ✓ | 97.27% |  |
| 32 | `RY_FreqOfTrading` | 近一年行情天数/交易日天数(%) | number(19,2) | ✓ | 0.0% |  |
| 33 | `RY_AggrATVR_I` | 近一年年化总换手率I(%) | number(19,2) | ✓ | 99.99% |  |
| 34 | `RY_AggrATVR_II` | 近一年年化总换手率II(%) | number(19,2) | ✓ | 100.0% |  |
| 35 | `RY_AggrATV` | 近一年年化总平均成交量 | number(30,6) | ✓ | 100.0% |  |
