...
| 5 | `Writer` | 撰写机构 | varchar2(50) | ✓ | 97.74% |  |
| 6 | `Author` | 作者 | varchar2(50) | ✓ | 13.06% |  |
| 7 | `InfoTitle` | 标题 | varchar2(200) | ✗ | 100.0% |  |
| 8 | `Content` | 信息内容 | clob | ✓ | 2.2% |  |
| 9 | `InvolvedStock` | 相关股票 | number(10) | ✓ | 100.0% |  |
...
| 12 | `MarketCode` | 信息涉及市场代码 | number(10) | ✓ | 99.91% | 信息涉及市场代码(MarketCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1009，得到... |
| 13 | `ForecastLowestPrice` | 预测价位最低价(元) | number(19,4) | ✓ | 32.35% |  |
| 14 | `ForecastHighestPrice` | 预测价位最高价(元) | number(19,4) | ✓ | 32.33% |  |
| 15 | `InfoLevel` | 信息级别 | number(10) | ✓ | 100.0% | 信息级别(InfoLevel)的取值为0；1；2，信息级别越高，内容的重要性等级越高。 |
| 16 | `RecordDate` | 记录录入时间 | date | ✓ | 80.14% |  |
| 17 | `XGRQ` | 更新时间 | date | ✗ |  |  |
