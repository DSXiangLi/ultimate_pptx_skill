...
| 属性 | 值 |
|------|-----|
| 表名 | `LC_STIBOperatingStatus` |
| MySQL表名 | `lc_stiboperatingstatus` |
| 中文名 | 科创板公司经营情况述评 |
...
1.内容说明：收录科创版公司管理层对季度、半年度、年度经营情况的自我评价，以及其后期发展计划和预测，本表涵盖了公司招股以来的历次纪录。
2.数据范围：2012年至今
3.信息来源：定期报告
...
| 3 | `InfoPublDate` | 信息发布日期 | date | ✓ | 77.39% |  |
| 4 | `EndDate` | 截止日期 | date | ✗ | 100.0% |  |
| 5 | `InfoSource` | 信息来源 | varchar2(50) | ✓ | 100.0% |  |
| 6 | `OperatingStatement` | 经营述评 | clob | ✓ | 99.99% |  |
