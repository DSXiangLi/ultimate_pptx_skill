...
| 属性 | 值 |
|------|-----|
| 表名 | `ED_ExchangeRateRMBtoUSD` |
| MySQL表名 | `ed_exchangeratermbtousd` |
| 中文名 | 各种货币对美元折算率 |
| 路径 | 聚源新版数据库 > 现货数据库 > 外汇 |
| 更新频率 | 月更新 |
| 字段数量 | 8 |
...
1.收录国际主要货币和美元的汇率，包括港元、人民币、欧元、英镑、日元等100多个币种与美元的汇率
2.数据范围：2002年1月-至今
3.数据源：国家外汇管理局
