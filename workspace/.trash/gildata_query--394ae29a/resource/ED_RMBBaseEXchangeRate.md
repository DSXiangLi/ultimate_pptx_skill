...
| 属性 | 值 |
|------|-----|
| 表名 | `ED_RMBBaseEXchangeRate` |
| MySQL表名 | `ed_rmbbaseexchangerate` |
| 中文名 | 人民币基准汇价 |
...
1.内容说明：收录人民币对其他主要币种的基准汇价，包含中国外汇交易中心披露的人民币对100单位外币的中间价的期初期末价、最高最低价等
2.数据范围：1994年1月至今
3.信息来源：国家外汇管理局
...
| 5 | `Currency` | 币种选择 | number(10) | ✗ | 100.0% | 币种选择(Currency)与(CT_SystemConst)表中的DM字段关联，令LB = 1068，得到币种选择的具... |
| 6 | `QuotationType` | 标价方式 | number(3) | ✓ | 100.0% | 标价方式（QuotationType），该字段固定以下常量：1-直接标价法；2-间接标价法 |
| 7 | `PeriodBegPrice` | 期初价 | number(19,4) | ✓ | 0.76% | 该字段单位为(人民币元/100外币  或 100外币/人民币元），具体可根据标价方式确定 |
| 8 | `PeriodEndPrice` | 期末价 | number(19,4) | ✓ | 96.04% | 该字段单位为(人民币元/100外币  或 100外币/人民币元），具体可根据标价方式确定 |
| 9 | `HighestPrice` | 最高价 | number(19,4) | ✓ | 32.4% | 该字段单位为(人民币元/100外币  或 100外币/人民币元），具体可根据标价方式确定 |
| 10 | `LowestPrice` | 最低价 | number(19,4) | ✓ | 32.4% | 该字段单位为(人民币元/100外币  或 100外币/人民币元），具体可根据标价方式确定 |
| 11 | `AveragePrice` | 期平均 | number(19,4) | ✓ | 5.14% | 该字段单位为(人民币元/100外币  或 100外币/人民币元），具体可根据标价方式确定 |
| 12 | `AccmdAvgPrice` | 累计平均 | number(19,4) | ✓ | 0.76% | 该字段单位为(人民币元/100外币  或 100外币/人民币元），具体可根据标价方式确定 |
| 13 | `XGRQ` | 修改日期 | date | ✗ |  |  |
