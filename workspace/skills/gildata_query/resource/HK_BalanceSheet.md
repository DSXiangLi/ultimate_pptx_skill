...
1.介绍港股资产负债表的相关指标，该表是资产负债表的竖表，数据内容和财报一致。
2.数据范围：1998年至今。
3.数据来源：港交所。
...
| 7 | `PeriodMark` | 日期标志 | number(10) | ✓ | 100.0% | 日期标志(PeriodMark)与系统常量表中的DM字段关联，令LB = 1314 and DM not in (90)... |
...
| 15 | `FinancialItem` | 科目代码 | number(10) | ✓ | 100.0% | 科目代码（FinancialItem）：与“系统常量表”中的“代码（DM）”关联，当AccountingStandard... |
...
| 18 | `AmountAtBegin` | 期初金额(元) | number(19,4) | ✓ | 85.51% |  |
| 19 | `AmountAtEnd` | 期末金额(元) | number(19,4) | ✓ | 91.18% |  |
...
科目代码（FinancialItem）：与“系统常量表”中的“代码（DM）”关联，当AccountingStandards会计准则为520-中国会计准则时，令LB=“1874”，得到科目代码的具体描述:110-流动资产，115-非流动资产，120-资产综合项目，125-资产总计，130-流动负债，135-非流动负债，140-负债综合项目，145-负债合计，150-股东权益，155-负债和股东权益综合项目，160-负债和股东权益总计，23-净流动资产，26-总资产减流动负债；当AccountingStandards会计准则不为520-中国会计准则时，令LB=“1373”，得到“科目代码”描述：11-非流动资产，14-流动资产，15-其他资产，17-总资产，20-流动负债，23-净流动资产，26-总资产减流动负债，27-总资产减总负债，29-非流动负债，30-其他负债，32-总负债，35-少数股东权益，38-净资产，41-资本及储备，44-其他权益，47-总权益，50-总权益及非流动负债，53-总权益及总负债，90-补充项目。

### ItemType (明细科目代码)

明细科目代码（ItemType）：与“系统常量表”中的“代码（DM）”关联：
（1）当AccountingStandards<>520 AND CompanyNature=2时，则LB=1376，得到明细科目代码的具体描述；
（2）当AccountingStandards<>520 AND CompanyNature<>2时，则LB=1375，得到明细科目代码的具体描述；
（3）当AccountingStandards=520 时，则LB=1877，得到明细科目代码的具体描述；
