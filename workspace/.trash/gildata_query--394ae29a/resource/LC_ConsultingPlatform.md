...
| 属性 | 值 |
|------|-----|
| 表名 | `LC_ConsultingPlatform` |
| MySQL表名 | `lc_consultingplatform` |
| 中文名 | 上市公司咨询互动平台 |
...
1.主要记录上市公司的投资者与上市公司董秘互动问答、传闻求证等内容,包括咨询日期,问题情况,问题回复,回复日期等内容。
2.数据范围：2018年1月起至今
