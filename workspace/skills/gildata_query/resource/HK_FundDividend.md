...
1.本表记录香港互认基金和香港ETF的分红派息情况。对于互认基金，除净日、派息日、记录日字段分别指中国内地的除息日、派息日及权益登记日。
2.历史数据：1999年11月起--至今。
3.数据来源：基金公司官网。
...
| 4 | `InfoChangeTime` | 公告更新日期 | date | ✓ | 26.67% |  |
| 5 | `FiscalYear` | 财政年份 | varchar2(4) | ✗ | 100.0% |  |
| 6 | `DividendPeriod` | 分配期 | number(10) | ✗ | 100.0% | 分配期(DividendPeriod)与(CT_SystemConst)表中的DM字段关联，令LB = 1800，得到分... |
| 7 | `CurrencyCode` | 币种 | number(10) | ✗ | 100.0% | 币种(CurrencyCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1068，得到币种的具... |
| 8 | `DividendMoney` | 派息金额(元/份) | number(19,8) | ✓ | 100.0% |  |
| 9 | `DividendMoneyHKD` | 派息金额(港元/份) | number(19,8) | ✓ | 100.0% |  |
| 10 | `ExDate` | 除净日 | date | ✓ | 99.92% |  |
| 11 | `DividendPayableDate` | 派息日 | date | ✓ | 96.2% |  |
| 12 | `RecordDate` | 记录日 | date | ✓ | 100.0% |  |
| 13 | `Statement` | 备注说明 | varchar2(1000) | ✓ | 1.89% |  |
...
分配期(DividendPeriod)与(CT_SystemConst)表中的DM字段关联，令LB = 1800，得到分配期的具体描述：1-月度，3-一季度，6-中期，9-三季度，12-期末。
