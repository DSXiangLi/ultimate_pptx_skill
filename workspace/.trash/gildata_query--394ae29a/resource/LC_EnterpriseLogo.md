...
| 属性 | 值 |
|------|-----|
| 表名 | `LC_EnterpriseLogo` |
| MySQL表名 | `lc_enterpriselogo` |
| 中文名 | 企业标志 |
...
| 6 | `LOGO` | logo | blob | ✓ | 3.96% |  |
| 7 | `PictureURL` | 图片链接 | varchar2(200) | ✓ | 97.22% | 图片链接（PictureURL）：自2023年7月20日停止维护。 |
