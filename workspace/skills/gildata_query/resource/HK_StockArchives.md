...
1.收录港股上市公司的基础信息，包括名称、成立日期、注册地点、注册资本、公司业务、所属行业分类、主席、公司秘书、联系方式等信息。
2.信息来源：港交所等。
...
| 4 | `EstablishmentDate` | 成立日期 | date | ✓ | 92.41% |  |
| 5 | `RegAbbr` | 注册地点 | number(10) | ✓ | 99.98% | 注册地点(RegAbbr)与(CT_SystemConst)表中的DM字段关联，令LB = 1023，得到注册地点的具体... |
| 6 | `CompanyType` | 公司类别 | number(10) | ✓ | 99.98% | 公司类别(CompanyType)与(CT_SystemConst)表中的DM字段关联，令LB = 1501，得到公司类... |
| 7 | `CompanyTypeDesc` | 公司类别描述 | varchar2(50) | ✓ | 99.98% |  |
| 8 | `Business` | 公司业务 | varchar2(1000) | ✓ | 99.98% |  |
| 9 | `InduCHKE` | 所属行业-港交所 | number(10) | ✓ | 29.63% | 所属行业-港交所（InduCHKE）:目前字段在该表已经不维护。 |
| 10 | `InduCHS` | 所属行业-恒生 | number(10) | ✓ | 40.54% | 所属行业-恒生（InduCHS）：目前字段在该表已经不维护，可以在 港股公司行业划分表HK_ExgIndustry获取到... |
| 11 | `Chairman` | 主席 | varchar2(100) | ✓ | 93.74% |  |
| 12 | `CompanySecretary` | 公司秘书 | varchar2(100) | ✓ | 97.63% |  |
| 13 | `CertifiedAccountant` | 合资格会计师 | varchar2(100) | ✓ | 21.55% |  |
| 14 | `RegisteredOffice` | 注册办事处 | varchar2(200) | ✓ | 99.83% |  |
| 15 | `GeneralOffice` | 总办事处及主要营业地点 | varchar2(200) | ✓ | 99.53% |  |
| 16 | `Registrars` | 股份过户处(香港) | varchar2(200) | ✓ | 68.94% |  |
| 17 | `Tel` | 电话 | varchar2(50) | ✓ | 87.96% |  |
| 18 | `Fax` | 传真 | varchar2(50) | ✓ | 68.49% |  |
| 19 | `Eail` | 邮箱 | varchar2(50) | ✓ | 82.65% |  |
| 20 | `Website` | 网址 | varchar2(200) | ✓ | 99.17% |  |
| 21 | `AuditInstitution` | 审计机构 | varchar2(500) | ✓ | 98.44% |  |
| 22 | `RegCapital` | 注册资本(万元) | number(19,4) | ✓ | 94.05% |  |
| 23 | `RegCapitalCurrency` | 注册资本货币单位 | number(10) | ✓ | 94.0% | 注册资本货币单位(RegCapitalCurrency)与(CT_SystemConst)表中的DM字段关联，令LB =... |
| 24 | `BriefIntroduction` | 公司简介 | clob | ✓ | 3.75% |  |
| 25 | `XGRQ` | 修改日期 | date | ✗ |  |  |
