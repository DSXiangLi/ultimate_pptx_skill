...
1.收录中国银行公布的当天首笔外汇价格，包括现汇买入价、现钞买入价、卖出价、基准价等
2.数据范围：1994年8月-至今
3.数据源：中国银行
...
| 3 | `InfoSource` | 信息来源 | varchar2(50) | ✓ | 56.7% |  |
| 4 | `StatPeriodCode` | 数据统计期间代码 | number(10) | ✓ | 100.0% | 数据统计期间代码(StatPeriodCode)与(CT_SystemConst)表中的DM字段关联，令LB = 107... |
| 5 | `CurrencyCode` | 货币代码 | number(10) | ✓ | 100.0% | 货币代码(CurrencyCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1068，得到货币... |
| 6 | `BidPriceSpot` | 现汇买入价(人民币元/100外币) | number(19,4) | ✓ | 88.18% |  |
| 7 | `AskedPriceSpot` | 现汇卖出价(人民币元/100外币) | number(19,4) | ✓ | 88.82% |  |
| 8 | `BidPriceCurrency` | 现钞买入价(人民币元/100外币) | number(19,4) | ✓ | 95.44% |  |
| 9 | `CashSellingRate` | 现钞卖出价(人民币元/100外币) | number(19,4) | ✓ | 57.9% |  |
| 10 | `BenchMarkPrice` | 基准价(人民币元/100外币) | number(19,4) | ✓ | 69.11% |  |
