...
1.本表记录香港互认基金和香港ETF的最新表现，包括周、一个月、三个月、半年、一年、二年、三年、五年、十年、成立以来的按复权净值计算的回报。
2.历史数据：2008年7月起-至今。
3.数据来源：聚源计算而得。
...
| 4 | `UnitNVRestored` | 复权单位净值(元) | number(18,4) | ✗ | 100.0% |  |
| 5 | `CurrencyCode` | 币种 | number(10) | ✓ | 100.0% | 币种(CurrencyCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1068，得到币种的具... |
| 6 | `NVDailyGrowthRate` | 日回报率(%) | number(18,4) | ✓ | 99.92% |  |
| 7 | `RRInSelectedWeek` | 本周以来回报率(%) | number(18,4) | ✓ | 99.76% |  |
| 8 | `RRInSingleWeek` | 一周回报率(%) | number(18,4) | ✓ | 99.6% |  |
| 9 | `RRInSelectedMonth` | 本月以来回报率(%) | number(18,4) | ✓ | 99.19% |  |
| 10 | `RRInSingleMonth` | 一个月回报率(%) | number(18,4) | ✓ | 98.27% |  |
| 11 | `RRInThreeMonth` | 三个月回报率(%) | number(18,4) | ✓ | 94.99% |  |
| 12 | `RRInSixMonth` | 六个月回报率(%) | number(18,4) | ✓ | 90.19% |  |
| 13 | `RRSinceThisYear` | 今年以来回报率(%) | number(18,4) | ✓ | 100.0% |  |
| 14 | `RRInSingleYear` | 一年回报率(%) | number(18,4) | ✓ | 81.13% |  |
| 15 | `RRInTwoYear` | 二年回报率(%) | number(18,4) | ✓ | 64.81% |  |
| 16 | `AnnualRRInTwoYear` | 二年年化回报率(%) | number(18,4) | ✓ | 64.81% |  |
| 17 | `RRInThreeYear` | 三年回报率(%) | number(18,4) | ✓ | 50.23% |  |
| 18 | `AnnualRRInThreeYear` | 三年年化回报率(%) | number(18,4) | ✓ | 50.23% |  |
| 19 | `RRInFiveYear` | 五年回报率(%) | number(18,4) | ✓ | 28.18% |  |
| 20 | `AnnualRRInFiveYear` | 五年年化回报率(%) | number(18,4) | ✓ | 28.18% |  |
| 21 | `RRInTenYear` | 十年回报率(%) | number(18,4) | ✓ | 7.55% |  |
| 22 | `AnnualRRInTenYear` | 十年年化回报率(%) | number(18,4) | ✓ | 7.55% |  |
| 23 | `RRSinceStart` | 设立以来回报率(%) | number(18,4) | ✓ | 100.0% |  |
| 24 | `AnnualRRSinceStart` | 设立以来年化回报率(%) | number(18,4) | ✓ | 100.0% |  |
