...
| 属性 | 值 |
|------|-----|
| 表名 | `DZ_AShareCDRHolder` |
| MySQL表名 | `dz_asharecdrholder` |
| 中文名 | CDR持有人 |
...
| 7 | `HolderNumber` | 持有人户数 | number(10) | ✓ | 32.86% |  |
| 8 | `HolderNo` | 持有人序号 | number(10) | ✗ | 100.0% |  |
...
| 12 | `HolderCategoryDesc` | 持有人类别描述 | varchar2(100) | ✓ | 34.43% |  |
| 13 | `HolderCategory` | 持有人类别 | number(10) | ✓ | 63.85% | 持有人类别(HolderCategory)与(CT_SystemConst)表中的DM字段关联，令LB = 1368，得... |
| 14 | `HolderNature` | 持有人性质 | number(10) | ✓ |  |  |
