...
| 属性 | 值 |
|------|-----|
| 表名 | `HK_CashFlowStatement` |
| MySQL表名 | `hk_cashflowstatement` |
| 中文名 | 港股现金流量表 |
...
1.介绍港股现金流量表中各项指标，该表是现金流量表的竖表，数据内容和财报一致。
2.数据范围：1998年至今。
3.数据来源：港交所。
...
| 14 | `ItemName` | 科目名称 | varchar2(200) | ✓ | 100.0% |  |
| 15 | `FinancialItem` | 科目代码 | number(10) | ✓ | 100.0% | 科目代码（FinancialItem）：与“系统常量表（CT_SystemConst）”中的“代码（DM）”关联，当Ac... |
| 16 | `ProjectName` | 明细科目名称 | varchar2(200) | ✓ | 100.0% |  |
| 17 | `ItemType` | 明细科目代码 | number(10) | ✓ | 100.0% | 明细科目代码（ItemType）：与“系统常量表”中的“代码（DM）”关联： （1）当AccountingStandar... |
| 18 | `LastPeriodAccount` | 同期金额(元) | number(19,4) | ✓ | 79.33% |  |
| 19 | `ThisPeriodAccount` | 本期金额(元) | number(19,4) | ✓ | 87.62% |  |
...
科目代码（FinancialItem）：与“系统常量表（CT_SystemConst）”中的“代码（DM）”关联，当AccountingStandards会计准则为520-中国会计准则时，令LB=“1876”,得到科目代码的具体描述:110-经营活动现金流入，115-经营活动现金流出，120-经营活动综合项目，125-经营活动现金净额，130-投资活动现金流入，135-投资活动现金流出，140-投资活动综合项目，145-投资活动现金净额，150-筹资活动现金流入，155-筹资活动现金流出，160-筹资活动综合项目，165-筹资活动现金净额，170-汇率变动，175-现金及等价物净增加额，180-期末现金及等价物余额，185-(附注)经营活动现金净额，190-补充项目，195-(附注)现金及等价物净增加额，当AccountingStandards会计准则不为520-中国会计准则时，令LB=“1374”，得到“财务科目”描述:10-经营业务调整，11-经营业务，14-税项，17-融资费用及投资回报，20-投资业务，23-融资前现金，26-融资业务，29-汇率影响，31-影响现金净额的其他项目，32-现金净额，35-现金期间变动，38-现金结余分析，40-补充资料。

### ItemType (明细科目代码)

明细科目代码（ItemType）：与“系统常量表”中的“代码（DM）”关联：
（1）当AccountingStandards<>520时，则LB=1384，得到明细科目代码的具体描述；
（2）当AccountingStandards=520时，则LB=1879，得到明细科目代码的具体描述；
