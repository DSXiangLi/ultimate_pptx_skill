...
1.收录SHIBOR、LIBOR、HIBOR、SIBOR、EURIBOR、TIBOR、SOFR等主要拆借市场的日拆借利率数据。
2.数据范围：1987-01-02 至今
3.信息来源：货币网、财资市场工会（香港）等
...
| 3 | `OfferedMarket` | 拆借市场 | number(10) | ✓ | 100.0% | 拆借市场(OfferedMarket)与(CT_SystemConst)表中的DM字段关联，令LB = 1155 AND... |
| 4 | `OfferedMaturity` | 拆借品种 | number(10) | ✓ | 100.0% | 拆借品种(OfferedMaturity)与(CT_SystemConst)表中的DM字段关联，令LB = 1157，得... |
| 5 | `OfferedMoney` | 拆借货币 | number(10) | ✓ | 100.0% | 拆借货币(OfferedMoney)与(CT_SystemConst)表中的DM字段关联，令LB = 1068 and ... |
| 6 | `WeightAveragePrice` | 加权价(%) | number(18,10) | ✓ | 100.0% |  |
| 7 | `InnerCode` | 内部编码 | number(10) | ✓ | 100.0% | 内部编码（InnerCode）：与“证券主表（SecuMain）”中的“证券内部编码（InnerCode）”关联，得到主... |
...
拆借市场(OfferedMarket)与(CT_SystemConst)表中的DM字段关联，令LB = 1155 AND DM NOT IN  (11,19,20,21,22,23,25) ，得到拆借市场的具体描述：1-LIBOR，2-HIBOR，3-SIBOR，4-CHIBOR，5-EURIBOR，6-SHIBOR，7-SHIBID，8-SHIMEAN，9-TIBOR，10-CNH HIBOR，12-ESTER，13-SOFR，14-SOFR百分位:1%，15-SOFR百分位:25%，16-SOFR百分位:75%，17-SOFR百分位:99%，18-Term SOFR，24-SORA，26-SONIA，27-TONAR。
