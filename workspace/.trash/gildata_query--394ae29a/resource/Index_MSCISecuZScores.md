...
| 属性 | 值 |
|------|-----|
| 表名 | `Index_MSCISecuZScores` |
| MySQL表名 | `index_mscisecuzscores` |
| 中文名 | MSCI指数成份Z值指标 |
...
内容说明：收录个股BV/P、E/P、股息率、EPS增长率等指标的Z值数据，用于判断个股风格属性（成长、价值）的标准化指标。
数据范围：2003年至今
信息来源：MSCI
...
| 6 | `InnerCode` | 证券内部编码 | number(10) | ✓ | 31.41% | 证券内部编码(InnerCode)：关联不同主表，查询证券代码、证券简称等基本信息。当0<SecuInnerCode<=... |
| 7 | `SecuMarket` | 证券市场 | number(10) | ✓ | 100.0% | 证券市场(SecuMarket)与(CT_SystemConst)表中的DM字段关联，令LB=201，得到证券市场的具体... |
| 8 | `Z_BookValueToPrice_US` | Z值_BVP_美国 | number(19,3) | ✓ | 0.03% |  |
| 9 | `Z_FwdEarnToPrice_US` | Z值_预测EP_美国 | number(19,3) | ✓ | 0.03% |  |
| 10 | `Z_Yield_US` | Z值_股息率_美国 | number(19,3) | ✓ | 0.03% |  |
| 11 | `Z_LTFEPSGrowth_US` | Z值_长期预测EPS增长率_美国 | number(19,3) | ✓ | 0.02% |  |
| 12 | `Z_STFEPSGrowth_US` | Z值_短期预测EPS增长率_美国 | number(19,3) | ✓ | 0.03% |  |
| 13 | `Z_InternalGrowth_US` | Z值_内部增长率_美国 | number(19,3) | ✓ | 0.03% |  |
| 14 | `Z_LTEPSGrowth_US` | Z值_长期EPS增长率_美国 | number(19,3) | ✓ | 0.03% |  |
| 15 | `Z_LTSPSGrowth_US` | Z值_长期SPS增长率_美国 | number(19,3) | ✓ | 0.03% |  |
| 16 | `Z_AggregateValue_US` | Z值_价值总值_美国 | number(19,3) | ✓ | 0.03% |  |
| 17 | `Z_AggregateGrowth_US` | Z值_成长总值_美国 | number(19,3) | ✓ | 0.03% |  |
| 18 | `Z_BookValueToPrice` | Z值_BVP | number(19,3) | ✓ | 99.9% |  |
| 19 | `Z_FwdEarnToPrice` | Z值_预测EP | number(19,3) | ✓ | 87.14% |  |
| 20 | `Z_Yield` | Z值_股息率 | number(19,3) | ✓ | 99.07% |  |
| 21 | `Z_LTFEPSGrowth` | Z值_长期预测EPS增长率 | number(19,3) | ✓ | 45.45% |  |
| 22 | `Z_STFEPSGrowth` | Z值_短期预测EPS增长率 | number(19,3) | ✓ | 86.64% |  |
| 23 | `Z_InternalGrowth` | Z值_内部增长率 | number(19,3) | ✓ | 98.61% |  |
| 24 | `Z_LTEPSGrowth` | Z值_长期EPS增长率 | number(19,3) | ✓ | 95.93% |  |
| 25 | `Z_LTSPSGrowth` | Z值_长期SPS增长率 | number(19,3) | ✓ | 90.3% |  |
| 26 | `Z_AggregateValue` | Z值_价值总值 | number(19,3) | ✓ | 99.99% |  |
| 27 | `Z_AggregateGrowth` | Z值_成长总值 | number(19,3) | ✓ | 99.87% |  |
