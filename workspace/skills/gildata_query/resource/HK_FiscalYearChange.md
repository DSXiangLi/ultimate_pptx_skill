...
| 属性 | 值 |
|------|-----|
| 表名 | `HK_FiscalYearChange` |
| MySQL表名 | `hk_fiscalyearchange` |
| 中文名 | 港股财政年度变动表 |
...
1.记录港股公司年度结算日的变动历史记录数据，包括信息发布日期、生效日期、变更前年结日、变更后年结日等。
2.数据范围：1999年至今。
3.信息来源：港交所。
...
| 5 | `SMAnnounceDate` | 股东大会公告日期 | date | ✓ | 0.02% |  |
...
| 8 | `FisYearBeforeChange` | 变更前年结日 | varchar2(5) | ✓ | 6.66% |  |
| 9 | `FisYearAfterChange` | 变更后年结日 | varchar2(5) | ✗ | 100.0% |  |
