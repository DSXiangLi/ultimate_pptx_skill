...
| 属性 | 值 |
|------|-----|
| 表名 | `LC_STIBStraLoanInfo` |
| MySQL表名 | `lc_stibstraloaninfo` |
| 中文名 | 科创板战略配售可出借信息 |
...
1、内容说明：记录科创板战略配售股份可参与融券上市流通的信息
2、数据范围：科创板上市之日起
3、信息来源：上交所
...
| 7 | `ALoanSharesSum` | 可出借总股数(股/份) | number(10) | ✓ | 100.0% | 可出借总股数(股)=剩余可出借股数(股)+已出借股数(股) |
| 8 | `ALoanShares` | 剩余可出借股数(股/份) | number(10) | ✓ | 100.0% |  |
