...
| 属性 | 值 |
|------|-----|
| 表名 | `HK_CorporationEquity` |
| MySQL表名 | `hk_corporationequity` |
| 中文名 | 港股董事相关法团权益 |
...
1.介绍港股董事在上市公司相关法团的持股数据，包括公司名称、法团名称、权益性质、以不同身份持有的股票数量等内容。
2.数据范围：2002年至今。
3.信息来源：港交所。
...
| 6 | `DirectorName` | 董事名称 | varchar2(200) | ✓ | 100.0% |  |
| 7 | `CorporationName` | 法团名称 | varchar2(200) | ✓ | 100.0% |  |
...
| 10 | `Unit` | 单位 | number(10) | ✓ | 1.05% | 单位(Unit)与(CT_SystemConst)表中的DM字段关联，令LB = 1068，得到单位的具体描述：1000... |
| 11 | `EquityStatus` | 权益身份 | number(10) | ✓ |  |  |
| 12 | `EquityStatusDesc` | 权益身份描述 | varchar2(200) | ✓ | 80.62% |  |
| 13 | `RelatingEquityStatus` | 相关权益身份 | number(10) | ✓ |  |  |
| 14 | `RelatingEquityStatusDesc` | 相关权益身份描述 | varchar2(200) | ✓ | 5.11% |  |
| 15 | `EquityVolume` | 权益总数(股) | number(18,2) | ✓ | 89.57% |  |
| 16 | `RatioInTotalShares` | 占已发行股份比例 | number(18,8) | ✓ | 83.1% |  |
| 17 | `HoldSum` | 1、股份权益总数(股) | number(18,2) | ✓ | 84.36% |  |
| 18 | `HSInTotalShares` | 占已发行股份比例 | number(18,8) | ✓ | 76.5% |  |
| 19 | `PersonalEquity` | #个人权益(股) | number(18,2) | ✓ | 45.54% |  |
| 20 | `FamilyEquity` | #家族权益(股) | number(18,2) | ✓ | 7.2% |  |
| 21 | `CompanyEquity` | #公司权益(股) | number(18,2) | ✓ | 18.68% |  |
| 22 | `OtherEquity` | #其他权益(股) | number(18,2) | ✓ | 10.72% |  |
| 23 | `RelatingEquityHoldSum` | 2、相关股份权益总数(股) | number(18,2) | ✓ | 10.98% |  |
| 24 | `REHSInTotalShares` | 占已发行股份比例 | number(18,8) | ✓ | 4.0% |  |
| 25 | `StockrightEquity` | #购股权权益(股) | number(18,2) | ✓ | 8.92% |  |
| 26 | `WarrantEquity` | #认股权证权益(股) | number(18,2) | ✓ | 0.44% |  |
| 27 | `ConvertibleBondEquity` | #可换股债券权益(股) | number(18,2) | ✓ | 0.38% |  |
| 28 | `OtherRelatingEquity` | #其他相关权益(股) | number(18,2) | ✓ | 1.06% |  |
| 29 | `Statement` | 备注 | clob | ✓ | 10.17% |  |
