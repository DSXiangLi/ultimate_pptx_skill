...
| 5 | `Writer` | 撰写机构 | varchar2(50) | ✓ | 8.79% |  |
| 6 | `Author` | 作者 | varchar2(50) | ✓ | 63.26% |  |
| 7 | `InfoTitle` | 标题 | varchar2(200) | ✗ | 100.0% |  |
| 8 | `Content` | 信息内容 | clob | ✓ | 0.39% |  |
| 9 | `InvolvedStock` | 相关股票 | number(10) | ✓ |  |  |
| 10 | `ObjectCode` | 信息对象代码 | number(10) | ✓ | 100.0% | 信息对象代码(ObjectCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1008，得到信息... |
| 11 | `AreaCode` | 信息地域划分代码 | number(10) | ✓ | 99.99% | 信息地域划分代码(AreaCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1023，得到信息... |
| 12 | `MarketCode` | 信息涉及市场代码 | number(10) | ✓ | 92.99% | 信息涉及市场代码(MarketCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1009，得到... |
| 13 | `InvolvedInstitution` | 涉及机构编号 | number(10) | ✓ | 1.74% | 涉及机构编号(InvolvedInstitution)和机构基本资料表(LC_InstiArchive)中公司代码(Co... |
| 14 | `InfoLevel` | 信息级别 | number(10) | ✓ | 100.0% | 信息级别(InfoLevel)的取值为0、1、2，信息级别越高，内容的重要性等级越高。 |
| 15 | `RecordDate` | 记录录入时间 | date | ✓ | 90.68% |  |
| 16 | `XGRQ` | 更新时间 | date | ✗ |  |  |
