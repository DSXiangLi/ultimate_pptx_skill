...
| 属性 | 值 |
|------|-----|
| 表名 | `DZ_NotTextAnnouncement` |
| MySQL表名 | `dz_nottextannouncement` |
| 中文名 | 公司公告原文非文本 |
...
1.内容说明：公司首次发行股票的招股说明书、招股意向书、上市公告书，公司增发新股招股说明书、增发新股招股意向书、增发新股上市公告书，公司A股配股说明书、B股配股说明书，公司发行可转换债券的可转换债券募集说明书、可转换债券上市公告书，吸收合并公告书、国有股回购公告书、国家股配售说明书、股份转让公告书，年报、中报、季报等定期公告、临时公告对应的公告属性类信息，如公告原文链接。
2.数据范围：证券上市-至今
...
| 4 | `InvolvedStock` | 相关股票 | number(10) | ✓ |  |  |
| 5 | `InfoPublDate` | 信息发布日期 | date | ✓ | 100.0% |  |
| 6 | `Media` | 媒体出处 | varchar2(100) | ✓ | 99.34% |  |
| 7 | `EndDate` | 截止日期 | date | ✓ | 100.0% |  |
| 8 | `Category` | 内容类别 | number(10) | ✓ | 100.0% | 内容类别(Category)与(CT_SystemConst)表中的DM字段关联，令LB = 1032，得到内容类别的具... |
| 9 | `InfoTitle` | 信息标题 | varchar2(200) | ✓ | 100.0% |  |
| 10 | `Content` | 信息内容 | blob | ✓ | 0.0% |  |
| 11 | `LanguageType` | 语言类别 | number(10) | ✓ | 100.0% | 语言类别(LanguageType)与(CT_SystemConst)表中的DM字段关联，令LB = 1238，得到语言... |
| 12 | `FileType` | 文件格式 | number(10) | ✓ | 100.0% | 文件格式(FileType)与(CT_SystemConst)表中的DM字段关联，令LB = 1309，得到文件格式的具... |
| 13 | `FileName` | 文件名 | varchar2(100) | ✓ | 7.25% |  |
...
| 17 | `AnnouncementLink` | 公告链接 | varchar2(1000) | ✓ | 83.42% |  |
| 18 | `HashCode` | MD5校验码 | varchar2(100) | ✓ | 100.0% |  |
| 19 | `InsertTime` | 发布时间 | date | ✗ |  | 发布时间(InsertTime)：指该条记录首次在本表发布的时间。 |
| 20 | `XGRQ` | 更新时间 | date | ✗ |  |  |
