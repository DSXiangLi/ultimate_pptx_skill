...
| 属性 | 值 |
|------|-----|
| 表名 | `LC_StockRecommend` |
| MySQL表名 | `lc_stockrecommend` |
| 中文名 | 个股资讯 |
...
| 5 | `Writer` | 撰写机构 | varchar2(50) | ✓ | 95.34% |  |
| 6 | `Author` | 作者 | varchar2(50) | ✓ | 39.74% |  |
| 7 | `InfoTitle` | 标题 | varchar2(200) | ✗ | 100.0% |  |
| 8 | `Content` | 信息内容 | clob | ✓ | 0.15% |  |
...
| 12 | `MarketCode` | 信息涉及市场代码 | number(10) | ✓ | 99.98% | 信息涉及市场代码(MarketCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1009，得到... |
| 13 | `OpinionCode` | 个股推荐意见类型 | number(10) | ✓ | 95.93% | 个股推荐意见类型(OpinionCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1031，得... |
| 14 | `Abstract` | 内容摘要 | varchar2(500) | ✓ | 69.6% |  |
| 15 | `InfoLevel` | 信息级别 | number(10) | ✓ | 100.0% | 信息级别(InfoLevel)的取值为0、1、2，信息级别越高，内容的重要性等级越高。 |
| 16 | `RecordDate` | 记录录入时间 | date | ✓ | 58.67% |  |
| 17 | `XGRQ` | 更新时间 | date | ✗ |  |  |
...
信息对象代码(ObjectCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1008 AND DM IN (1000,1001,1003,1004,1005,1006,1007,1009,1300,1301,1303,1500,1503,1506,1507,1509,1512,1515,1900,1901)，得到信息对象代码的具体描述：1000-股票，1001-A股，1003-B股，1004-H股，1005-红筹股，1006-个股期权，1007-权证，1009-股指期货，1300-基金，1301-封闭式基金，1303-开放式基金，1500-债券，1503-国债，1506-企债，1507-公司债，1509-金融债，1512-回购，1515-可转债，1900-理财产品，1901-银行理财产品。
