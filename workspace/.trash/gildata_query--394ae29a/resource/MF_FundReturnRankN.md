...
| 属性 | 值 |
|------|-----|
| 表名 | `MF_FundReturnRankN` |
| MySQL表名 | `mf_fundreturnrankn` |
| 中文名 | 公募基金收益率最新排名 |
...
1.内容说明：本表记录公募基金收益率、收益率(最新）同类均值及排名。
2.数据范围：每个产品的最新交易日。
...
| 11 | `FundAnnReturn` | 基金年化收益率(%) | number(18,9) | ✓ | 31.05% | 基金年化收益率(%)(FundAnnReturn): 非货币及短期债券理财型基金取自公募基金净值历史表现(MF_NetV... |
...
指标周期(IndexCycle)与(CT_SystemConst)表中的DM字段关联，令LB = 2149 and DM in(1,7,3,6,12,24,36,60,120,998,999)，得到指标周期的具体描述：1-一个月，3-三个月，6-六个月，7-七天，12-一年，24-两年，36-三年，60-五年，120-十年，998-今年以来，999-成立以来。
