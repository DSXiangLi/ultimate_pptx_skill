...
| 4 | `Currency` | 货币 | number(10) | ✓ | 100.0% | 货币(Currency)与(CT_SystemConst)表中的DM字段关联，令LB = 1068，得到货币的具体描述：... |
| 5 | `IfDesShtSec` | 是否指定卖空证券 | number(10) | ✓ | 100.0% | 是否指定卖空证券(IfDesShtSec)与(CT_SystemConst)表中的DM字段关联，令LB = 1906，得... |
| 6 | `ShortSharesAM` | 上午卖空数量(股) | number(18,6) | ✓ | 92.6% |  |
| 7 | `ShortAmtAM` | 上午卖空金额(元) | number(19,4) | ✓ | 92.6% |  |
| 8 | `ShortShares` | 全天卖空数量(股) | number(18,6) | ✓ | 100.0% |  |
| 9 | `ShortAmt` | 全天卖空金额(元) | number(19,4) | ✓ | 100.0% |  |
| 10 | `Volume` | 全天成交量(股) | number(18,6) | ✓ | 100.0% |  |
| 11 | `Turnover` | 全天成交额(元) | number(19,4) | ✓ | 100.0% |  |
| 12 | `AdjShortShares` | 调整全天卖空数量(股) | number(18,6) | ✓ | 97.76% |  |
| 13 | `AdjShortAmt` | 调整全天卖空金额(元) | number(19,4) | ✓ | 97.76% |  |
