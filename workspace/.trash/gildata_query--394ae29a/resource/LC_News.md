...
1.收录各主流媒体发布的公司新闻报道，包括互动关系平台上的互动新闻。
2.数据范围：2001-至今
...
| 5 | `Writer` | 撰写机构 | varchar2(50) | ✓ | 0.25% |  |
| 6 | `Author` | 作者 | varchar2(50) | ✓ | 45.08% |  |
| 7 | `InfoTitle` | 标题 | varchar2(200) | ✗ | 100.0% |  |
| 8 | `Content` | 信息内容 | clob | ✓ | 0.17% |  |
...
| 13 | `InvolvedInstitution` | 涉及机构编号 | number(10) | ✓ | 1.18% | 涉及机构编号(InvolvedInstitution)和机构基本资料表(LC_InstiArchive)中公司代码(Co... |
| 14 | `RecordDate` | 记录录入时间 | date | ✓ | 96.55% |  |
| 15 | `XGRQ` | 更新时间 | date | ✗ |  |  |
