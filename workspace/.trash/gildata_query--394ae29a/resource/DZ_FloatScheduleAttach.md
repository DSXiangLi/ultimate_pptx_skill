...
| 属性 | 值 |
|------|-----|
| 表名 | `DZ_FloatScheduleAttach` |
| MySQL表名 | `dz_floatscheduleattach` |
| 中文名 | 限售股票解禁时间表附表 |
...
1.本表收录以上市公司为维度统计的各预计解禁日期下的限售股份来源
2.数据范围：2006-至今
3.信息来源：上市公司公告
...
| 3 | `ChangeType` | 股本变动原因类别 | number(10) | ✗ | 100.0% | 股本变动原因类别(ChangeType)与(CT_SystemConst)表中的DM字段关联，令LB = 1022 AN... |
