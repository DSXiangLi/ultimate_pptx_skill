...
1.收录主流媒体报道的基金市场新闻资讯，涵盖了基金新闻、基金市场走势、基金市场分析评论等。
2.数据范围：2002-至今
...
| 5 | `Writer` | 撰写机构 | varchar2(50) | ✓ | 3.54% |  |
| 6 | `Author` | 作者 | varchar2(50) | ✓ | 16.42% |  |
| 7 | `InfoTitle` | 标题 | varchar2(200) | ✗ | 100.0% |  |
| 8 | `Content` | 信息内容 | clob | ✓ | 0.54% |  |
...
| 12 | `MarketCode` | 信息涉及市场代码 | number(10) | ✓ | 86.2% | 信息涉及市场代码(MarketCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1009 AN... |
| 13 | `InvolvedInstitution` | 涉及机构编号 | number(10) | ✓ | 8.6% | 涉及机构编号(InvolvedInstitution)和机构基本资料表(LC_InstiArchive)中公司代码(Co... |
| 14 | `InfoLevel` | 信息级别 | number(10) | ✓ | 100.0% | 信息级别(InfoLevel)的取值为1、2、3、4，信息级别越高，内容的重要性等级越高。 |
| 15 | `RecordDate` | 记录录入时间 | date | ✓ | 97.18% |  |
| 16 | `XGRQ` | 更新时间 | date | ✗ |  |  |
...
信息涉及市场代码(MarketCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1009 AND DM = 1001，得到信息涉及市场代码的具体描述：1001-主板。
