...
| 5 | `Writer` | 撰写机构 | varchar2(50) | ✓ | 5.75% |  |
| 6 | `Author` | 作者 | varchar2(50) | ✓ | 51.95% |  |
...
| 11 | `AreaCode` | 信息地域划分代码 | number(10) | ✓ | 99.88% | 信息地域划分代码(AreaCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1023，得到信息... |
| 12 | `MarketCode` | 信息涉及市场代码 | number(10) | ✓ | 74.83% | 信息涉及市场代码(MarketCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1009，得到... |
| 13 | `InvolvedInstitution` | 涉及机构编号 | number(10) | ✓ | 1.53% | 涉及机构编号(InvolvedInstitution)和机构基本资料表(LC_InstiArchive)中公司代码(Co... |
| 14 | `InfoLevel` | 信息级别 | number(10) | ✓ | 100.0% | 信息级别(InfoLevel)的取值为0、1、2，信息级别越高，内容的重要性等级越高。 |
| 15 | `RecordDate` | 记录录入时间 | date | ✓ | 93.3% |  |
| 16 | `XGRQ` | 更新时间 | date | ✗ |  |  |
