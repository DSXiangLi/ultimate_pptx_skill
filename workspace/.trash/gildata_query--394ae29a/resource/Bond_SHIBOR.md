...
1.内容说明：收录SHIBOR上海银行间同业拆借市场的日拆借利率数据。
...
| 5 | `OfferedMaturity` | 拆借品种 | varchar2(10) | ✓ | 100.0% |  |
| 6 | `OfferedMoney` | 拆借货币 | number(10) | ✓ | 100.0% | 拆借货币(OfferedMoney)与(CT_SystemConst)表中的DM字段关联，令LB = 1068，得到拆借... |
| 7 | `WeightAveragePrice` | 加权价(%) | number(18,10) | ✓ | 100.0% |  |
