...
| 属性 | 值 |
|------|-----|
| 表名 | `ED_HotSpecialTopic` |
| MySQL表名 | `ed_hotspecialtopic` |
| 中文名 | 热点专题 |
...
1.收录热点资讯信息，包括标题、作者、信息内容、信息对象、信息地域划分、所属专题等情况。
2.数据范围：2003-至今
...
| 4 | `MediaCode` | 媒体出处代码 | number(10) | ✓ | 98.93% | 媒体出处代码(MediaCode)与(NI_NewsConst)表中的DM字段关联，令LB = 4，得到媒体出处代码的具... |
| 5 | `Writer` | 撰写机构 | varchar2(50) | ✓ | 4.43% |  |
| 6 | `Author` | 作者 | varchar2(50) | ✓ | 83.37% |  |
| 7 | `InfoTitle` | 标题 | varchar2(200) | ✓ | 100.0% |  |
| 8 | `Content` | 信息内容 | clob | ✓ | 0.41% |  |
| 9 | `ObjectCode` | 信息对象代码 | number(10) | ✓ | 100.0% | 信息对象代码(ObjectCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1008，得到信息... |
| 10 | `AreaCode` | 信息地域划分代码 | number(10) | ✓ | 99.96% | 信息地域划分代码(AreaCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1023，得到信息... |
| 11 | `InfoLevel` | 信息级别 | number(10) | ✓ | 100.0% | 信息级别(InfoLevel)的取值为0、1、2 |
| 12 | `SpecialCode` | 信息所属专题 | number(10) | ✓ |  |  |
| 13 | `RecordDate` | 记录录入时间 | date | ✓ | 98.54% |  |
| 14 | `XGRQ` | 更新时间 | date | ✗ |  |  |
