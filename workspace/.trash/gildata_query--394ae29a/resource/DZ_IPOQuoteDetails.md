...
| 属性 | 值 |
|------|-----|
| 表名 | `DZ_IPOQuoteDetails` |
| MySQL表名 | `dz_ipoquotedetails` |
| 中文名 | A股IPO投资者报价情况 |
...
| 9 | `InvestorID` | 投资者编码 | number(10) | ✓ | 93.39% | 投资者编码(InvestorID):根据“InvestorType(投资者类型)”来确定, 当InvestorType(... |
...
| 13 | `BidderID` | 配售对象编码 | number(10) | ✓ | 69.7% | 配售对象编码(BidderID)：根据“BidderType(配售对象类型)”来确定, 当BidderType(配售对象... |
| 14 | `BidderCode` | 配售对象代码 | varchar2(20) | ✓ | 3.97% |  |
| 15 | `SecuAccountNumber` | 证券账户号码 | varchar2(20) | ✓ | 71.62% |  |
...
| 20 | `LimitSaleType` | 限售方式 | number(10) | ✓ | 0.4% | 限售方式(LimitSaleType)与(CT_SystemConst)表中的DM字段关联，令LB=2668，得到限售方... |
| 21 | `LimitSalePeriod` | 限售期 | number(10) | ✓ | 0.4% |  |
| 22 | `LimitSalePeriodUnit` | 限售期单位 | number(10) | ✓ | 0.4% | 限售期单位(LimitSalePeriodUnit)与(CT_SystemConst)表中的DM字段关联，令LB=102... |
| 23 | `RestriHoldingRatio` | 限售比例(%) | number(9,4) | ✓ | 0.4% |  |
