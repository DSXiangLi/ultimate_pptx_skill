...
1.记录港股公司证券代码的变动历史记录数据，包括信息发布时间、生效时间、变动前代码、变动后代码等。                                        2.数据范围：1997年至今。
3.信息来源：港交所。
...
| 3 | `InfoPublDate` | 信息发布日期 | date | ✓ | 81.45% |  |
| 4 | `InfoSource` | 信息来源 | number(10) | ✓ | 23.32% | 信息来源(InfoSource)与(CT_SystemConst)表中的DM字段关联，令LB = 1926，得到信息来源... |
...
| 8 | `CodeBeforeChange` | 变更前代码 | varchar2(20) | ✓ | 0.31% |  |
| 9 | `CodeAfterChange` | 变更后代码 | varchar2(20) | ✓ | 100.0% |  |
| 10 | `ExpiryDate` | 失效日期 | date | ✓ | 0.31% |  |
