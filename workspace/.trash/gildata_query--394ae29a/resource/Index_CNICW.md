...
内容说明：收录国证股票类指数，当日权重及计算用股本、市值等数据。
数据范围：2020年至今
信息来源：深圳证券信息有限公司
...
| 5 | `WeightedRatio` | 权重(%) | number(19,6) | ✓ | 100.0% |  |
| 6 | `ClosePrice` | 收盘价(元) | number(19,4) | ✓ | 100.0% |  |
| 7 | `TotalShares` | 总股本(股) | number(19,2) | ✓ | 14.48% |  |
| 8 | `AdjustedShares` | 计算用股本(股) | number(19,2) | ✓ | 100.0% |  |
| 9 | `MarketValue` | 总市值(元) | number(19,4) | ✓ | 14.48% |  |
| 10 | `AdjustedMV` | 计算用市值(元) | number(19,4) | ✓ | 14.48% |  |
| 11 | `Currency` | 交易货币 | number(10) | ✓ | 100.0% |  |
| 12 | `ExchangeRate` | 汇率 | number(19,8) | ✓ | 74.41% |  |
