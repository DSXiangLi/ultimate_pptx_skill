...
| 属性 | 值 |
|------|-----|
| 表名 | `LC_LeaderIntroduce` |
| MySQL表名 | `lc_leaderintroduce` |
| 中文名 | 公司领导人介绍 |
...
1.收录A\B股上市公司在任和历任的领导人的简历介绍，包括姓名、职位、职称、性别、出生年月、学历背景、上任离任日期等内容。
2.信息来源：上市公司公告
...
| 4 | `PersonalCode` | 人员编码 | number(10) | ✓ | 98.94% |  |
| 5 | `InfoSource` | 信息来源 | varchar2(50) | ✓ | 99.94% |  |
| 6 | `LeaderName` | 姓名 | varchar2(50) | ✗ | 100.0% |  |
| 7 | `Position` | 职位 | number(10) | ✓ |  |  |
| 8 | `LeaderTitle` | 职称 | number(10) | ✓ |  |  |
| 9 | `TermNumIn` | 任职届次 | number(10) | ✓ |  |  |
| 10 | `LeaderGender` | 性别 | number(10) | ✓ | 97.76% | 性别(LeaderGender)与(CT_SystemConst)表中的DM字段关联，令LB = 1234，得到性别的具... |
| 11 | `BirthYM` | 出生年月 | date | ✓ | 95.33% |  |
| 12 | `BirthYMInfo` | 出生年月(文本) | varchar2(20) | ✓ | 92.45% |  |
| 13 | `LeaderDegree` | 学历 | number(10) | ✓ | 90.17% | 学历(LeaderDegree)与(CT_SystemConst)表中的DM字段关联，令LB = 1154，得到学历的具... |
| 14 | `Nationality` | 国籍 | number(10) | ✓ | 94.5% | 国籍(Nationality)与(CT_SystemConst)表中的DM字段关联，令LB=1023，得到国籍的具体描述... |
| 15 | `Background` | 背景介绍 | clob | ✓ | 0.05% |  |
| 16 | `IfIn` | 在任与否 | number(10) | ✓ | 100.0% | 在任与否(IfIn)：1- 是，0- 否 |
| 17 | `InDate` | 上任日期 | date | ✓ | 96.77% |  |
| 18 | `OffDate` | 离任日期 | date | ✓ | 66.49% |  |
| 19 | `ConcurrentPost` | 兼职状况 | varchar2(255) | ✓ | 36.68% |  |
| 20 | `Statement` | 备注 | varchar2(1000) | ✓ | 91.63% |  |
| 21 | `XGRQ` | 更新日期 | date | ✗ |  |  |
...
学历(LeaderDegree)与(CT_SystemConst)表中的DM字段关联，令LB = 1154，得到学历的具体描述：1-博士后，2-博士，3-硕士，4-本科，5-大专，6-高中，7-中专，8-其他，9-初中及以下。
