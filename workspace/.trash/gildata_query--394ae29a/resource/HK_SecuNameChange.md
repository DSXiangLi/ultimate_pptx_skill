...
| 属性 | 值 |
|------|-----|
| 表名 | `HK_SecuNameChange` |
| MySQL表名 | `hk_secunamechange` |
| 中文名 | 港股公司名称变动表 |
...
1.记录港股公司名称的变动历史记录数据，包括中文名称、中文名称缩写、英文名称、英文名称缩写等数据。
2.数据范围：1999年至今。
3.信息来源：港交所。
...
| 5 | `SMAnnounceDate` | 股东大会公告日期 | date | ✓ | 9.13% |  |
| 6 | `EventType` | 事项类别 | number(10) | ✗ | 100.0% | 事项类别(EventType)与(CT_SystemConst)表中的DM字段关联，令LB = 1345 AND DM ... |
...
| 9 | `NameBeforeChange` | 变更前名称 | varchar2(200) | ✓ | 28.7% |  |
| 10 | `AbbrBeforeChange` | 变更前名称缩写 | varchar2(100) | ✓ | 6.98% |  |
| 11 | `NameAfterChange` | 变更后名称 | varchar2(200) | ✓ | 100.0% |  |
| 12 | `AbbrAfterChange` | 变更后名称缩写 | varchar2(100) | ✓ | 22.81% |  |
| 13 | `ExpiryDate` | 失效日期 | date | ✓ | 27.88% |  |
...
事项类别(EventType)与(CT_SystemConst)表中的DM字段关联，令LB = 1345 AND DM IN (1105,1120,1115,1110)，得到事项类别的具体描述：1105-中文全称，1110-英文全称，1115-中文证券简称，1120-英文证券简称。
