...
| 4 | `SecuMarket` | 证券市场 | number(10) | ✓ | 42.32% | 证券市场(SecuMarket)与(CT_SystemConst)表中的DM字段关联，令LB = 201，得到证券市场的... |
| 5 | `ChangeType` | 变更类型 | number(10) | ✗ | 100.0% | 变更类型(ChangeType)与(CT_SystemConst)表中的DM字段关联，令LB = 1184，得到变更类型... |
| 6 | `LargeApplyingMax` | 基金大额申购上限(元) | number(19,4) | ✓ | 8.98% |  |
