...
1.描述新会计准则下，上市公司在资产负债表附注中公布的投资性房产、生产性生物资产、油气资产等资产的明细情况。
...
| 6 | `AssetCategory` | 资产类别 | number(10) | ✗ | 100.0% | 资产类别(AssetCategory)与(CT_SystemConst)表中的DM字段关联，令 LB = 1041 AN... |
...
| 9 | `CurrencyCode` | 计价货币 | number(10) | ✓ | 50.53% | 计价货币(CurrencyCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1068，得到计价... |
| 10 | `OpeningNetValue` | 净值期初金额(元) | number(19,4) | ✓ | 90.24% |  |
| 11 | `CurrentIncreaseNV` | 净值本期增加(元) | number(19,4) | ✓ | 21.55% |  |
| 12 | `CurrentDecreaseNV` | 净值本期减少(元) | number(19,4) | ✓ | 9.84% |  |
| 13 | `EndingNetValue` | 净值期末金额(元) | number(19,4) | ✓ | 99.09% |  |
| 14 | `EndingOriginalValue` | 原值期末金额(元) | number(19,4) | ✓ | 91.08% |  |
| 15 | `EndingCalculatingSum` | 期末计提金额(元) | number(19,4) | ✓ | 8.9% |  |
| 16 | `EndingAccuAmortization` | 累计摊销期末金额(元) | number(19,4) | ✓ | 86.72% |  |
...
资产类别(AssetCategory)与(CT_SystemConst)表中的DM字段关联，令 LB = 1041 AND DM IN (13301,13302,13303)，得到资产类别的具体描述：13301-投资性房产，13302-生产性生物资产，13303-油气资产。
