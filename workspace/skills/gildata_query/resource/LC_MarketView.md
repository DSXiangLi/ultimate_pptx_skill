...
1.收录各投资金融机构对证券、基金、债券市场、行情走势的各种评论信息。
2.数据范围：2001-至今
...
| 5 | `Writer` | 撰写机构 | varchar2(50) | ✓ | 92.74% |  |
| 6 | `Author` | 作者 | varchar2(50) | ✓ | 60.52% |  |
| 7 | `InfoTitle` | 标题 | varchar2(200) | ✗ | 100.0% |  |
| 8 | `Content` | 信息内容 | clob | ✓ | 0.26% |  |
...
| 12 | `MarketCode` | 信息涉及市场代码 | number(10) | ✓ | 98.49% | 信息涉及市场代码(MarketCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1009，得到... |
| 13 | `InvolvedInstitution` | 涉及机构编号 | number(10) | ✓ | 0.01% | 涉及机构编号(InvolvedInstitution)和机构基本资料表(LC_InstiArchive)中公司代码(Co... |
| 14 | `InfoLevel` | 信息级别 | number(10) | ✓ | 100.0% | 信息级别(InfoLevel)的取值为0；1；2，信息级别越高，内容的重要性等级越高。 |
| 15 | `RecordDate` | 记录录入时间 | date | ✓ | 59.2% |  |
| 16 | `XGRQ` | 更新时间 | date | ✗ |  |  |
