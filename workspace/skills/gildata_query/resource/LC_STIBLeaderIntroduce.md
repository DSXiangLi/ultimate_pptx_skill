...
| 属性 | 值 |
|------|-----|
| 表名 | `LC_STIBLeaderIntroduce` |
| MySQL表名 | `lc_stibleaderintroduce` |
| 中文名 | 科创板高管及核心技术人员背景 |
...
1.内容说明：收录科创板上市公司在任和历任的领导人及核心技术人员背景的简历介绍，包括姓名、职位、职称、性别、出生年月、学历背景、上任离任日期等内容。
2.数据范围：2019年-至今
...
| 6 | `PersonalCode` | 人员编码 | number(10) | ✓ | 98.37% |  |
| 7 | `Position` | 职位 | number(10) | ✓ |  |  |
| 8 | `LeaderTitle` | 职称 | number(10) | ✓ |  |  |
| 9 | `Gender` | 性别 | number(10) | ✓ | 98.99% | 性别(Gender)与(CT_SystemConst)表中的DM字段关联，令LB = 1234，得到性别的具体描述：1-... |
| 10 | `BirthYM` | 出生年月 | date | ✓ | 98.53% |  |
| 11 | `BirthYMInfo` | 出生年月(文本) | varchar2(20) | ✓ | 98.53% |  |
| 12 | `EducationLevel` | 学历 | number(10) | ✓ | 97.43% | 学历(EducationLevel)与(CT_SystemConst)表中的DM字段关联，令LB = 1154，得到学历... |
| 13 | `Nationality` | 国籍 | number(10) | ✓ | 97.75% | 国籍(Nationality)与(CT_SystemConst)表中的DM字段关联，令LB=1023，得到国籍的具体描述... |
| 14 | `Background` | 背景介绍 | clob | ✓ | 0.6% |  |
| 15 | `Incumbent` | 在任与否 | number(10) | ✓ | 100.0% | 在任与否(Incumbent)：1- 是，0- 否 |
| 16 | `InDate` | 上任日期 | date | ✓ | 100.0% |  |
| 17 | `OffDate` | 离任日期 | date | ✓ | 33.7% |  |
| 18 | `ConcurrentPost` | 兼职状况 | varchar2(255) | ✓ | 28.1% |  |
| 19 | `Statement` | 变更说明 | varchar2(1000) | ✓ | 70.49% |  |
...
公司代码(CompanyCode)：与“证券主表(SecuMain)”中的“公司代码(CompanyCode)”关联，限定上市板块(ListedSector)=7，得到科创板上市公司的交易代码、简称等。
