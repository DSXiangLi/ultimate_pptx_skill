...
| 属性 | 值 |
|------|-----|
| 表名 | `DZ_IntAssetsDetail` |
| MySQL表名 | `dz_intassetsdetail` |
| 中文名 | 公司研发投入与产出 |
...
| 5 | `InfoSourceCode` | 信息来源编码 | number(10) | ✓ | 100.0% | 信息来源编码(InfoSourceCode)与(CT_SystemConst)表中的DM字段关联，令LB=2181，得到... |
...
| 9 | `ExpensedRDInput` | 费用化研发投入(元) | number(19,4) | ✓ | 84.31% |  |
| 10 | `CapitalizedRDInput` | 资本化研发投入(元) | number(19,4) | ✓ | 73.5% |  |
| 11 | `TotalRDInput` | 研发投入合计(元) | number(19,4) | ✓ | 99.51% |  |
| 12 | `RDInputRatio` | 研发投入占营业收入比例(%) | number(19,6) | ✓ | 99.18% |  |
| 13 | `CapitalizedRDInputR` | 资本化研发投入占比(%) | number(6,2) | ✓ | 73.66% |  |
| 14 | `RDStaffNum` | 研发人员数量 | number(6,0) | ✓ | 62.83% |  |
| 15 | `RDStaffNumRatio` | 研发人员数量占比(%) | number(6,2) | ✓ | 62.44% |  |
| 16 | `CoreTechnicalStaffNum` | 核心技术人员数量 | number(6,0) | ✓ | 5.04% |  |
| 17 | `CoreTechnicalStaffR` | 核心技术人员数量占比(%) | number(6,2) | ✓ | 5.03% |  |
| 18 | `CoreTechnologyOutput` | 核心技术营业收入(元) | number(19,4) | ✓ | 4.49% |  |
| 19 | `CoreTechnologyOutputR` | 核心技术营业收入占比(%) | number(19,6) | ✓ | 4.42% |  |
