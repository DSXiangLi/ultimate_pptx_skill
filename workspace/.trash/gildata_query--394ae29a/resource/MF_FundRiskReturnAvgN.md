...
| 属性 | 值 |
|------|-----|
| 表名 | `MF_FundRiskReturnAvgN` |
| MySQL表名 | `mf_fundriskreturnavgn` |
| 中文名 | 基金平均风险收益率(全) |
...
1.内容说明：记录不同计算周期、计算步长、无风险收益率下的平均风险收益率值，平均风险收益率=平均收益率-无风险收益率。
2.数据范围：2022年9月起-至今。
...
| 6 | `InSingleMonth` | 截止日1月前 | number(18,9) | ✓ | 60.56% |  |
| 7 | `InTwoMonth` | 截止日2月前 | number(18,9) | ✓ | 62.97% |  |
| 8 | `InThreeMonth` | 截止日3月前 | number(18,9) | ✓ | 79.77% |  |
| 9 | `InSixMonth` | 截止日6月前 | number(18,9) | ✓ | 79.55% |  |
| 10 | `InSingleYear` | 截止日1年前 | number(18,9) | ✓ | 72.57% |  |
| 11 | `InTwoYear` | 截止日2年前 | number(18,9) | ✓ | 58.68% |  |
| 12 | `InThreeYear` | 截止日3年前 | number(18,9) | ✓ | 56.69% |  |
| 13 | `InFiveYear` | 截止日5年前 | number(18,9) | ✓ | 34.43% |  |
| 14 | `InSevenYear` | 截止日7年前 | number(18,9) | ✓ | 21.03% |  |
| 15 | `InTenYear` | 截止日10年前 | number(18,9) | ✓ | 8.78% |  |
| 16 | `SinceThisYear` | 今年以来 | number(18,9) | ✓ | 80.74% |  |
| 17 | `SinceStart` | 成立以来 | number(18,9) | ✓ | 99.31% |  |
