...
| 属性 | 值 |
|------|-----|
| 表名 | `DZ_LeaderIntroduce` |
| MySQL表名 | `dz_leaderintroduce` |
| 中文名 | 公司领导人介绍 |
...
内容说明：收录A\B股上市公司（包括科创板）在任和历任的领导人的简历介绍，包括姓名、职位、职称、性别、出生年月、学历背景、上任离任日期等内容。
数据范围：国内上市公司
信息来源：招股说明书、临时公告等。
...
| 6 | `PersonalCode` | 人员编码 | number(10) | ✓ | 98.9% |  |
| 7 | `Position` | 职位 | number(10) | ✓ |  |  |
| 8 | `LeaderTitle` | 职称 | number(10) | ✓ |  |  |
| 9 | `TermNumIn` | 任职届次 | number(10) | ✓ |  |  |
| 10 | `LeaderGender` | 性别 | number(10) | ✓ | 97.81% | 性别(LeaderGender)与(CT_SystemConst)表中的DM字段关联，令LB = 1234，得到性别的具... |
| 11 | `BirthYM` | 出生年月 | date | ✓ | 95.46% |  |
| 12 | `BirthYMInfo` | 出生年月(文本) | varchar2(20) | ✓ | 92.7% |  |
| 13 | `LeaderDegree` | 学历 | number(10) | ✓ | 90.48% | 学历(LeaderDegree)与(CT_SystemConst)表中的DM字段关联，令LB = 1154，得到学历的具... |
| 14 | `Nationality` | 国籍 | number(10) | ✓ | 94.62% | 国籍(Nationality)与(CT_SystemConst)表中的DM字段关联，令LB=1023，得到国籍的具体描述... |
| 15 | `Background` | 背景介绍 | clob | ✓ | 0.06% |  |
| 16 | `IfIn` | 在任与否 | number(10) | ✓ | 100.0% | 在任与否(IfIn)：1-是，0-否 |
| 17 | `InDate` | 上任日期 | date | ✓ | 96.9% |  |
| 18 | `OffDate` | 离任日期 | date | ✓ | 65.06% |  |
| 19 | `ConcurrentPost` | 兼职状况 | varchar2(255) | ✓ | 36.29% |  |
| 20 | `Statement` | 备注 | varchar2(1000) | ✓ | 90.67% |  |
