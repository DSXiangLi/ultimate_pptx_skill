...
| 3 | `Media` | 媒体出处 | varchar2(50) | ✓ | 100.0% |  |
| 4 | `MediaCode` | 媒体出处代码 | number(10) | ✓ | 99.99% | 媒体出处代码(MediaCode)与(NI_NewsConst)表中的DM字段关联，令LB = 4，得到媒体出处代码的具... |
| 5 | `InfoTitle` | 标题 | varchar2(200) | ✓ | 100.0% |  |
| 6 | `Content` | 信息内容 | clob | ✓ | 1.48% |  |
| 7 | `Writer` | 撰写机构 | varchar2(50) | ✓ | 21.3% |  |
| 8 | `Author` | 撰写作者 | varchar2(50) | ✓ | 59.91% |  |
| 9 | `ObjectCode` | 信息对象代码 | number(10) | ✓ | 100.0% | 信息对象代码(ObjectCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1008，得到信息... |
| 10 | `AreaCode` | 信息地域划分代码 | number(10) | ✓ | 99.99% | 信息地域划分代码(AreaCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1023，得到信息... |
| 11 | `ContentType` | 证券知识内容类别 | number(10) | ✓ | 100.0% | 证券知识内容类别(ContentType)与(CT_SystemConst)表中的DM字段关联，令LB = 1179，得... |
| 12 | `InfoLevel` | 信息级别 | number(10) | ✓ | 100.0% | 信息级别(InfoLevel)的取值为0、1、2，信息级别越高，内容的重要性等级越高。 |
| 13 | `RecordDate` | 记录录入时间 | date | ✓ | 45.73% |  |
| 14 | `XGRQ` | 更新时间 | date | ✗ |  |  |
