...
| 5 | `Writer` | 撰写机构 | varchar2(100) | ✓ | 4.56% |  |
| 6 | `Author` | 作者 | varchar2(100) | ✓ | 84.77% |  |
| 7 | `InfoTitle` | 标题 | varchar2(200) | ✗ | 100.0% |  |
| 8 | `Content` | 信息内容 | clob | ✓ | 0.24% |  |
| 9 | `ObjectCode` | 信息对象代码 | number(10) | ✓ | 99.98% | 信息对象代码(ObjectCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1008，得到信息... |
| 10 | `AreaCode` | 信息地域划分代码 | number(10) | ✓ | 99.94% | 信息地域划分代码(AreaCode)与(CT_SystemConst)表中的DM字段关联，令LB = 1023，得到信息... |
| 11 | `SpecialCategory` | 专题类别 | number(10) | ✓ |  |  |
| 12 | `InfoLevel` | 信息级别 | number(10) | ✓ | 100.0% | 信息级别(InfoLevel)的取值为0、1、2，信息级别越高，内容的重要性等级越高。 |
| 13 | `RecordDate` | 记录录入时间 | date | ✓ | 99.25% |  |
| 14 | `XGRQ` | 更新时间 | date | ✗ |  |  |
