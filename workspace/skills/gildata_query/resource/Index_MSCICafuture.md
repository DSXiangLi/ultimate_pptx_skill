...
| 属性 | 值 |
|------|-----|
| 表名 | `Index_MSCICafuture` |
| MySQL表名 | `index_mscicafuture` |
| 中文名 | MSCI指数成份公司行为 |
...
内容说明：本表收录MSCI指数成份的公司行为具体描述，包括实施日期、条款说明、价格调整因子、对纳入因子的影响、所属系列变更等信息。
数据范围：2024年至今
信息来源：MSCI
...
| 5 | `CATypeCode` | 行为类别 | number(10) | ✗ | 100.0% | 行为类别(CATypeCode)与(CT_SystemConst)表中的DM字段关联，令LB=1764，得到行为类别的具... |
| 6 | `CATypeName` | 行为类别名称 | varchar2(60) | ✗ | 100.0% |  |
| 7 | `EffectiveDate` | 生效日期 | date | ✗ | 100.0% |  |
| 8 | `EventCode` | 事件编号 | number(10) | ✗ | 100.0% |  |
| 9 | `InnerCode` | 证券内部编码 | number(10) | ✓ | 57.44% | 证券内部编码(InnerCode)：关联不同主表，查询证券代码、证券简称等基本信息。当0<SecuInnerCode<=... |
| 10 | `SecuMarket` | 证券市场 | number(10) | ✓ | 100.0% | 证券市场(SecuMarket)与(CT_SystemConst)表中的DM字段关联，令LB=201，得到证券市场的具体... |
| 11 | `RIC` | 路孚特代码 | varchar2(100) | ✓ | 100.0% |  |
| 12 | `ISIN` | ISIN | varchar2(50) | ✓ | 96.82% |  |
| 13 | `SEDOL` | SEDOL | varchar2(50) | ✓ | 97.04% |  |
| 14 | `TICKER` | 彭博代码 | varchar2(50) | ✓ | 97.03% |  |
| 15 | `Status` | 实施状态 | varchar2(20) | ✓ | 100.0% |  |
| 16 | `ActionDesc` | 行为描述 | varchar2(500) | ✓ | 100.0% |  |
| 17 | `TermRemark` | 条款说明 | varchar2(500) | ✓ | 74.82% |  |
| 18 | `CorrectionDetail` | 修正详情 | varchar2(500) | ✓ | 2.03% |  |
| 19 | `LastUpdateDate` | 最新更新日期 | date | ✓ | 100.0% |  |
| 20 | `FirstPublDate` | 首次发布日期 | date | ✓ | 100.0% |  |
| 21 | `EngName` | 英文名称 | varchar2(100) | ✓ | 99.66% |  |
| 22 | `EngName_New` | 英文名称(新) | varchar2(100) | ✓ | 89.52% |  |
| 23 | `RegionCode` | 国家及地区代码 | number(10) | ✓ | 99.66% | 国家及地区代码(RegionCode)：与“国家城市代码表(LC_AreaCode)”中的“地区内部编码(AreaInn... |
| 24 | `RegionCode_New` | 国家及地区代码(新) | number(10) | ✓ | 89.19% | 国家及地区代码(新)(RegionCode_New)：与“国家城市代码表(LC_AreaCode)”中的“地区内部编码(... |
| 25 | `CurrencyCode` | 币种 | number(10) | ✓ | 99.51% | 币种(CurrencyCode)与(CT_SystemConst)表中的DM字段关联，令LB=1548，得到币种的具体描... |
| 26 | `CurrencyCode_New` | 币种(新) | number(10) | ✓ | 89.39% | 币种(新)(CurrencyCode_New)与(CT_SystemConst)表中的DM字段关联，令LB=1548，得... |
| 27 | `FourthIndustryCode` | 四级行业代码 | varchar2(50) | ✓ | 99.66% |  |
| 28 | `FourthIndustryCode_New` | 四级行业代码(新) | varchar2(50) | ✓ | 89.52% |  |
| 29 | `FourthIndustryName` | 四级行业名称 | varchar2(50) | ✓ | 99.66% |  |
| 30 | `FourthIndustryName_New` | 四级行业名称(新) | varchar2(50) | ✓ | 89.52% |  |
| 31 | `CloseNOSI` | 收盘股本数量1 | number(28,6) | ✓ | 99.66% |  |
| 32 | `CloseNOSI_New` | 收盘股本数量1(新) | number(28,6) | ✓ | 89.52% |  |
| 33 | `CloseNOSII` | 收盘股本数量2 | number(28,6) | ✓ | 99.66% |  |
| 34 | `CloseNOSII_New` | 收盘股本数量2(新) | number(28,6) | ✓ | 89.52% |  |
| 35 | `PAF_Formula` | 价格调整因子计算公式 | varchar2(500) | ✓ | 61.31% |  |
| 36 | `PriceAdjFactor` | 价格调整因子 | number(21,6) | ✓ | 16.57% |  |
| 37 | `LimitedInvestFactor` | 投资限制因子 | number(21,4) | ✓ | 99.66% |  |
| 38 | `LimitedInvestFactor_New` | 投资限制因子(新) | number(21,4) | ✓ | 89.52% |  |
| 39 | `ForeignOwnershipLimit` | 外资限制因子 | number(21,4) | ✓ | 99.66% |  |
| 40 | `ForeignOwnershipLimit_New` | 外资限制因子(新) | number(21,4) | ✓ | 89.52% |  |
| 41 | `ForeignIncFactor` | 外资纳入因子 | number(21,4) | ✓ | 99.66% |  |
| 42 | `ForeignIncFactor_New` | 外资纳入因子(新) | number(21,4) | ✓ | 89.52% |  |
| 43 | `DomesticIncFactor` | 内资纳入因子 | number(21,4) | ✓ | 99.66% |  |
| 44 | `DomesticIncFactor_New` | 内资纳入因子(新) | number(21,4) | ✓ | 89.52% |  |
| 45 | `Std_IIF` | 标准指数纳入因子 | number(21,4) | ✓ | 65.92% |  |
| 46 | `Std_IIF_New` | 标准指数纳入因子(新) | number(21,4) | ✓ | 60.37% |  |
| 47 | `Scap_IIF` | 小盘纳入因子 | number(21,4) | ✓ | 34.35% |  |
| 48 | `Scap_IIF_New` | 小盘纳入因子(新) | number(21,4) | ✓ | 29.76% |  |
| 49 | `ValueIncFactor` | 价值纳入因子 | number(21,4) | ✓ | 27.2% |  |
| 50 | `ValueIncFactor_New` | 价值纳入因子(新) | number(21,4) | ✓ | 23.05% |  |
| 51 | `GrowthIncFactor` | 成长纳入因子 | number(21,4) | ✓ | 27.2% |  |
| 52 | `GrowthIncFactor_New` | 成长纳入因子(新) | number(21,4) | ✓ | 23.05% |  |
| 53 | `USValueIncFactor` | 美国价值纳入因子 | number(21,4) | ✓ | 0.0% |  |
| 54 | `USValueIncFactor_New` | 美国价值纳入因子(新) | number(21,4) | ✓ | 0.0% |  |
| 55 | `USGrowthIncFactor` | 美国成长纳入因子 | number(21,4) | ✓ | 0.0% |  |
| 56 | `USGrowthIncFactor_New` | 美国成长纳入因子(新) | number(21,4) | ✓ | 0.0% |  |
| 57 | `IslamicIncFactor` | 伊斯兰纳入因子 | number(21,4) | ✓ | 65.92% |  |
| 58 | `IslamicIncFactor_New` | 伊斯兰纳入因子(新) | number(21,4) | ✓ | 66.18% |  |
| 59 | `IfStandard` | 是否标准系列 | number(10) | ✓ | 65.92% |  |
| 60 | `IfStandard_New` | 是否标准系列(新) | number(10) | ✓ | 66.18% |  |
| 61 | `IfStandardDOM` | 是否标准国内系列 | number(10) | ✓ | 65.92% |  |
| 62 | `IfStandardDOM_New` | 是否标准国内系列(新) | number(10) | ✓ | 66.18% |  |
| 63 | `IfLarge` | 是否大盘系列 | number(10) | ✓ | 65.92% |  |
| 64 | `IfLarge_New` | 是否大盘系列(新) | number(10) | ✓ | 66.18% |  |
| 65 | `IfLargeDOM` | 是否大盘国内系列 | number(10) | ✓ | 65.92% |  |
| 66 | `IfLargeDOM_New` | 是否大盘国内系列(新) | number(10) | ✓ | 66.18% |  |
| 67 | `IfMid` | 是否中盘系列 | number(10) | ✓ | 65.92% |  |
| 68 | `IfMid_New` | 是否中盘系列(新) | number(10) | ✓ | 66.18% |  |
| 69 | `IfMidDOM` | 是否中盘国内系列 | number(10) | ✓ | 65.92% |  |
| 70 | `IfMidDOM_New` | 是否中盘国内系列(新) | number(10) | ✓ | 66.18% |  |
| 71 | `IfSmall` | 是否小盘系列 | number(10) | ✓ | 34.35% |  |
| 72 | `IfSmall_New` | 是否小盘系列(新) | number(10) | ✓ | 34.43% |  |
| 73 | `IfSmallDOM` | 是否小盘国内系列 | number(10) | ✓ | 34.35% |  |
| 74 | `IfSmallDOM_New` | 是否小盘国内系列(新) | number(10) | ✓ | 34.43% |  |
| 75 | `IfMicro` | 是否微盘系列 | number(10) | ✓ | 34.35% |  |
| 76 | `IfMicro_New` | 是否微盘系列(新) | number(10) | ✓ | 34.43% |  |
| 77 | `IfDM` | 是否发达市场系列 | number(10) | ✓ | 100.0% |  |
| 78 | `IfEM` | 是否新兴市场系列 | number(10) | ✓ | 100.0% |  |
| 79 | `IfFM` | 是否前沿市场系列 | number(10) | ✓ | 100.0% |  |
| 80 | `IfUSLarge` | 是否美国大盘系列 | number(10) | ✓ | 0.0% |  |
| 81 | `IfUSLarge_New` | 是否美国大盘系列(新) | number(10) | ✓ | 0.0% |  |
| 82 | `IfUSMid` | 是否美国中盘系列 | number(10) | ✓ | 0.0% |  |
| 83 | `IfUSMid_New` | 是否美国中盘系列(新) | number(10) | ✓ | 0.0% |  |
| 84 | `IfUSSmall` | 是否美国小盘系列 | number(10) | ✓ | 0.0% |  |
| 85 | `IfUSSmall_New` | 是否美国小盘系列(新) | number(10) | ✓ | 0.0% |  |
| 86 | `IfUSMicro` | 是否美国微盘系列 | number(10) | ✓ | 0.0% |  |
| 87 | `IfUSMicro_New` | 是否美国微盘系列(新) | number(10) | ✓ | 0.0% |  |
| 88 | `Z_CalDate` | Z值计算日期 | date | ✓ | 0.0% |  |
| 89 | `Z_AggregateValue` | Z值_价值总值 | number(19,3) | ✓ | 0.02% |  |
| 90 | `Z_AggregateGrowth` | Z值_成长总值 | number(19,3) | ✓ | 0.02% |  |
| 91 | `Z_AggregateValue_US` | Z值_价值总值_美国 | number(19,3) | ✓ | 0.0% |  |
| 92 | `Z_AggregateGrowth_US` | Z值_成长总值_美国 | number(19,3) | ✓ | 0.0% |  |
| 93 | `UpdateTime` | 修改时间 | date | ✗ |  |  |
...
国家及地区代码(RegionCode)：与“国家城市代码表(LC_AreaCode)”中的“地区内部编码(AreaInnerCode)”关联，得到具体信息。

### RegionCode_New (国家及地区代码(新))

国家及地区代码(新)(RegionCode_New)：与“国家城市代码表(LC_AreaCode)”中的“地区内部编码(AreaInnerCode)”关联，得到具体信息。
...
### CurrencyCode_New (币种(新))

币种(新)(CurrencyCode_New)与(CT_SystemConst)表中的DM字段关联，令LB=1548，得到币种(新)的具体描述：1000-美元，1100-港元，1110-印度卢比，1120-印度尼西亚卢比，1130-伊朗里亚尔，1140-波兰兹罗提，1150-匈牙利福林，1160-日本元，1161-欧洲日元(离岸)，1170-约旦第纳尔，1180-科威特第纳尔，1190-阿联酋迪拉姆，1200-亚美尼亚德拉姆，1210-澳门元，1220-马来西亚林吉特，1230-安第列斯群岛盾，1240-安哥拉宽扎，1250-尼泊尔卢比，1260-哈萨克斯坦坚戈，1270-巴基斯坦卢比，1280-阿鲁巴岛弗罗林，1290-菲律宾比索，1300-阿塞拜疆马纳特，1310-波斯尼亚马克，1320-新加坡元，1330-韩国元，1340-孟加拉塔卡，1350-百慕大元，1360-泰国铢，1370-沙特里亚尔，1380-文莱林吉特，1390-不丹努尔特鲁姆，1400-博茨瓦纳普拉，1410-白俄罗斯卢布，1420-人民币元，1430-台湾元，1440-伯利兹元，1450-南苏丹镑，1460-世界投资报告法郎，1470-佛得角埃斯库多，1480-厄立特里亚纳克法，1490-埃塞俄比亚比尔，1500-福克兰群岛镑，1510-格鲁吉亚拉里，1520-直布罗陀镑，1530-克罗地亚库纳，1540-以色列新谢克尔，1550-吉尔吉斯斯坦索姆，1560-开曼群岛元，1570-莱索托马洛蒂，1580-摩尔多瓦列伊，1590-马其顿第纳尔，1600-蒙古图格里克，1610-马拉维克瓦查，1620-梅蒂卡尔，1630-纳米比亚元，1640-巴布亚新几内亚基那，1650-塞尔维亚第纳尔，1660-圣赫勒拿群岛磅，1670-圣多美和普林西比多布拉，1680-太平洋法郎，1690-非共体法郎，1700-斯威士兰里兰吉尼，1710-塔吉克斯坦索莫尼，1720-土库曼斯坦马纳特，1730-汤加潘加，1740-乌克兰格里夫纳，1750-乌兹别克斯坦苏姆，1760-瓦努阿图瓦图，1770-萨摩亚塔拉，1780-中非金融合作法郎，1790-东加勒比元，1800-哈萨克斯坦腾格(废弃)，1810-人民币(离岸)，2470-坦桑尼亚先令，3000-欧元，3010-比利时法郎，3020-丹麦克朗，3030-英