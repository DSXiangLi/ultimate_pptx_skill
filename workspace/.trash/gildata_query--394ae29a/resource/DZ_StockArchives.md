...
内容说明：收录上市公司（包括科创板）的基本情况，包括：联系方式、注册信息、中介机构、行业和产品、公司证券品种及背景资料等内容。
数据范围：国内上市公司
信息来源：临时公告、招股说明书、定报
...
| 23 | `RegZipCode` | 公司注册地址邮编 | varchar2(50) | ✓ | 90.2% |  |
| 24 | `OfficeAddr` | 公司办公地址 | varchar2(200) | ✓ | 99.99% |  |
| 25 | `OfficeZipCode` | 公司办公地址邮编 | varchar2(50) | ✓ | 99.84% |  |
| 26 | `ContactAddr` | 公司联系地址 | varchar2(200) | ✓ | 100.0% |  |
| 27 | `ConatactZipCode` | 公司联系地址邮编 | varchar2(50) | ✓ | 99.97% |  |
...
| 35 | `LegalRepr` | 法人代表 | varchar2(100) | ✓ | 99.98% |  |
...
| 40 | `BusinessMajor` | 经营范围-主营 | clob | ✓ | 0.63% |  |
| 41 | `BusinessMinor` | 经营范围-兼营 | clob | ✓ | 0.14% |  |
...
| 50 | `BriefIntroText` | 公司简介 | clob | ✓ | 0.59% |  |
